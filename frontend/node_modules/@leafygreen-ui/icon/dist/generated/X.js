...
var idAllocator = IdAllocator.create('X');
var X = function (_a) {
    var _b;
    ...
    return (React.createElement("svg", __assign({ className: cx((_b = {},
        ...
        title === undefined ? (React.createElement("title", { id: titleId }, 'Glyphs / X')) : title ? (React.createElement("title", { id: titleId }, title)) : null,
        React.createElement("g", { id: "Audit", stroke: "none", strokeWidth: 1, fill: "none", fillRule: "evenodd" },
            React.createElement("path", { d: "M9,1.5 L8.999,7 L14.5,7 L14.5,9 L8.999,9 L9,14.5 L7,14.5 L6.999,9 L1.5,9 L1.5,7 L6.999,7 L7,1.5 L9,1.5 Z", transform: "translate(8.000000, 8.000000) rotate(45.000000) translate(-8.000000, -8.000000)", fill: 'currentColor' }))));
};
X.displayName = 'X';
X.isGlyph = true;
X.propTypes = {
